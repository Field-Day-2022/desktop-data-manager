...
class NewFieldDialog extends Component {
    ...
    getFieldErrors = (field) => {
        ...
        if (SCHEMAS[type].options && !((options && options.length) || answer_set)) {
            return `No options or answer set provided, please add either options or an answer set to your ${FIELD_TYPES[type]}.`;
        }
            ...
            <Fragment>
                ...
                {usesAnswerSet ? (
                    <AnswerSetSelect
                        ...
                        onChangeAnswerSet={this.handleAnswerSetChange}
                    />
                ) : (
                    <TextField
    ...
    getTooltip = () => {
        return (
            <div>
                ...
                <li>
                    Counter: A counter component to keep track of a number a quantity of something
                </li>
    ...
    render() {
        ...
        return (
            <Dialog open={open} onClose={this.handleCancel} aria-labelledby="field-dialog-title">
                ...
                <DialogContent>
                    <DialogContentText>
                        Add a new field to your form. Choose the field type, options, and
                        attributes.
                    </DialogContentText>
