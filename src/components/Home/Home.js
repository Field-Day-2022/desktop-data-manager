                ...
                <div className={classes.homeContainer}>
                    <Paper square={false} className={classes.bodyPaper}>
                        ...
                        <Typography variant="h6" className={classes.headlineText}>
                            FieldDay builds rich, dynamic forms for mobile data collection and
                            query.
                        </Typography>
                    </Paper>
                        ...
                        <Paper square={false} className={classes.listPaper}>
                            ...
                            <List dense>
                                {sessionForms.length ? (
                                    ...
                                    <Typography
                                        variant="caption"
                                        className="App-drawer-section-title"
                                    >
                                        No Session Forms found. Create one in the Form Builder
                                        above.
                                    </Typography>
                                )}
                            </List>
