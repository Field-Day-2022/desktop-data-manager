                    ...
                    <div key={form.form_id}>
                        ...
                        <ListItem button>
                            <ListItemText
                                ...
                                onClick={this.handleFormOpen(form.form_id)}
                            />
                        </ListItem>
                    </div>
                );
            ...
            <Fragment>
                <Paper className="App-page-paper">
                    ...
                    <Typography component="p">
                        View, create, and modify forms for data collection. Data Forms describe
                        individual observations of a single entity type. Session Forms describe a
                        collection of data entries across multiple different Data Forms.
                    </Typography>
                </Paper>
